...
DarkRP.createShipment("P228", {
    ...
    pricesep = 400,
    noship = true,
    customCheck = function(ply) if JobRanks[ply:Team()] and JobRanks[ply:Team()].Entities["tfcss_p228"] and JobRanks[ply:Team()].Entities["tfcss_p228"] > ply:GetJobRank() then return false else return true end end,
    CustomCheckFailMsg = function(ply) return "You must be Lvl" ..  JobRanks[ply:Team()].Entities["tfcss_p228"] .. " to purchase this." end,
...
DarkRP.createShipment("Glock18", {
    ...
    pricesep = 550,
    noship = true,
    customCheck = function(ply) if JobRanks[ply:Team()] and JobRanks[ply:Team()].Entities["tfcss_glock"] and JobRanks[ply:Team()].Entities["tfcss_glock"] > ply:GetJobRank() then return false else return true end end,
    CustomCheckFailMsg = function(ply) return "You must be Lvl" .. JobRanks[ply:Team()].Entities["tfcss_glock"] .. " to purchase this." end,
    allowed = {TEAM_SURVEY_SUPPORT, TEAM_SECURITYCHEIF,TEAM_SECURITY, TEAM_SECURITYRECRUIT},
    onBought = function(ply, shipment) ply:Give(shipment.entity) end,
})
...
DarkRP.createShipment("FiveseveN", {
	...
	pricesep = 550,
	noship = true,
    customCheck = function(ply) if JobRanks[ply:Team()] and JobRanks[ply:Team()].Entities["tfcss_fiveseven"] and JobRanks[ply:Team()].Entities["tfcss_fiveseven"] > ply:GetJobRank() then return false else return true end end,
    CustomCheckFailMsg = function(ply) return "You must be Lvl. " .. JobRanks[ply:Team()].Entities["tfcss_fiveseven"] .. " to purchase this." end,
	allowed = {TEAM_SURVEY_SUPPORT, TEAM_SECURITYCHEIF,TEAM_SECURITY,TEAM_SECURITYRECRUIT},
    onBought = function(ply, shipment) ply:Give(shipment.entity) end,
})
--[[-------------------------------------------------------------------------
...
DarkRP.createShipment("Desert Eagle", {
    ...
    pricesep = 550,
    noship = true,
    customCheck = function(ply) if JobRanks[ply:Team()] and JobRanks[ply:Team()].Entities["tfcss_deagle"] and JobRanks[ply:Team()].Entities["tfcss_deagle"] > ply:GetJobRank() then return false else return true end end,
    CustomCheckFailMsg = function(ply) return "You must be Lvl. " .. JobRanks[ply:Team()].Entities["tfcss_deagle"] .. " to purchase this." end,
    allowed = {TEAM_SURVEY_SUPPORT, TEAM_SECURITYCHEIF,TEAM_SECURITY,TEAM_SECURITYRECRUIT, TEAM_HECUCOMMAND,TEAM_HECUMED,TEAM_HECU,TEAM_HECUSPECOPS},
    onBought = function(ply, shipment) ply:Give(shipment.entity) end,
})
...
DarkRP.createShipment("HK USP", {
    ...
    pricesep = 750,
    noship = true,
    customCheck = function(ply) if JobRanks[ply:Team()] and JobRanks[ply:Team()].Entities["tfcss_usp"] and JobRanks[ply:Team()].Entities["tfcss_usp"] > ply:GetJobRank() then return false else return true end end,
    CustomCheckFailMsg = function(ply) return "You must be Lvl. " .. JobRanks[ply:Team()].Entities["tfcss_usp"] .. " to purchase this." end,
    allowed = {TEAM_SURVEY_SUPPORT, TEAM_SECURITYCHEIF,TEAM_SECURITY,TEAM_SECURITYRECRUIT, TEAM_HECUCOMMAND,TEAM_HECUMED,TEAM_HECU,TEAM_HECUSPECOPS},
    onBought = function(ply, shipment) ply:Give(shipment.entity) end,
})
...
DarkRP.createShipment("MAC 10", {
    ...
    pricesep = 1000,
    noship = true,
    customCheck = function(ply) if JobRanks[ply:Team()] and JobRanks[ply:Team()].Entities["tfcss_mac10"] and JobRanks[ply:Team()].Entities["tfcss_mac10"] > ply:GetJobRank() then return false else return true end end,
    CustomCheckFailMsg = function(ply) return "You must be Lvl. " ..  JobRanks[ply:Team()].Entities["tfcss_mac10"] .. " to purchase this." end,
...
DarkRP.createShipment("M4", {
    ...
    pricesep = 850,
    noship = true,
    customCheck = function(ply) if JobRanks[ply:Team()] and JobRanks[ply:Team()].Entities["tfcss_m4a1"] and JobRanks[ply:Team()].Entities["tfcss_m4a1"] > ply:GetJobRank() then return false else return true end end,
    CustomCheckFailMsg = function(ply) return "You must be Lvl. " ..  JobRanks[ply:Team()].Entities["tfcss_m4a1"] .. " to purchase this." end,
    allowed = {TEAM_HECUCOMMAND,TEAM_HECUMED,TEAM_HECU,TEAM_HECUSPECOPS, TEAM_SECURITY},
    onBought = function(ply, shipment) ply:Give(shipment.entity) end,
})
...
DarkRP.createShipment("Xm1014", {
    ...
    pricesep = 850,
    noship = true,
    customCheck = function(ply) if JobRanks[ply:Team()] and JobRanks[ply:Team()].Entities["tfcss_xm1014"] and JobRanks[ply:Team()].Entities["tfcss_xm1014"] > ply:GetJobRank() then return false else return true end end,
    CustomCheckFailMsg = function(ply) return "You must be Lvl. " ..  JobRanks[ply:Team()].Entities["tfcss_xm1014"] .. " to purchase this." end,
...
DarkRP.createShipment("AWP", {
    ...
    pricesep = 850,
    noship = true,
    customCheck = function(ply) if JobRanks[ply:Team()] and JobRanks[ply:Team()].Entities["tfcss_awp"] and JobRanks[ply:Team()].Entities["tfcss_awp"] > ply:GetJobRank() then return false else return true end end,
    CustomCheckFailMsg = function(ply) return "You must be Lvl. " ..  JobRanks[ply:Team()].Entities["tfcss_awp"] .. " to purchase this." end,
    allowed = {TEAM_HECUCOMMAND,TEAM_HECUMED,TEAM_HECU,TEAM_HECUSPECOPS},
    onBought = function(ply, shipment) ply:Give(shipment.entity) end,
})
--[[-------------------------------------------------------------------------
