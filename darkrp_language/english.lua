...
local my_language = {
    ...
    no_privilege = "You lack the required authorization.",
    ...
    payday_message = "You have recieved %s for research funding!",
    payday_unemployed = "You have not recieved any funding as you are not a BMRF Employee!",
    payday_missed = "Your funding has been skipped. (You're arrested)",

    property_tax = "Lab fee! %s",
    property_tax_cant_afford = "You couldn't pay the Lab fee! Your Lab has been taken away from you!",
    taxday = "Lab fee! %s%% of your budget was taken!",
    ...
    wanted_by_police = "%s is wanted by the Security!\nReason: %s\nOrdered by: %s",
    wanted_by_police_print = "%s has made %s wanted, reason: %s",
    wanted_expired = "%s is no longer wanted by the Security.",
    wanted_revoked = "%s is no longer wanted by the Security.\nRevoked by: %s",
    cant_arrest_other_cp = "You cannot arrest other Security!",
    ...
    need_to_be_cp = "You have to be a member of the Security force.",
    ...
    door_unownable = "This lab cannot be owned or unowned!",
    door_sold = "You have sold this for %s",
    door_already_owned = "This lab is already owned by someone!",
    door_cannot_afford = "You can not afford this door!",
    door_hobo_unable = "You can not buy a lab if you are a hobo!",
    vehicle_cannot_afford = "You can not afford this vehicle!",
    door_bought = "You've bought this lab for %s%s",
    vehicle_bought = "You've bought this vehicle for %s%s",
    door_need_to_own = "You need to own this lab in order to be able to %s",
    door_rem_owners_unownable = "You can not remove owners if a lab is non-ownable!",
    door_add_owners_unownable = "You can not add owners if a lab is non-ownable!",
    ...
    edit_door_group = "Edit lab group",
    door_groups = "lab groups",
    door_group_doesnt_exist = "lab group does not exist!",
    door_group_set = "lab group set successfully.",
    ...
    listen_up = "Alert!", -- In rp_tell or rp_tellall
