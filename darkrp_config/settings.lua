...
GM.Config.F1MenuHelpPage = "https://sbmrp.com"
...
GM.Config.allowedProperties = {
    ...
    skin = true,
    bodygroups = true,
	rb655_door_open = true,
	rb655_door_close = true,
	rb655_door_lock = true,
	rb655_door_unlock = true,
	rb655_func_movelinear_open = true,
	rb655_func_movelinear_close = true,
	rb655_func_tracktrain_StartForward = true,
	rb655_func_tracktrain_StartBackward = true,
	rb655_func_tracktrain_Stop = true,
	rb655_func_tracktrain_Resume = true,
	rb655_breakable_break = true,
	rb655_turret_toggle = true,
	rb655_turret_ammo_remove = true,
	rb655_turret_ammo_restore = true,
	rb655_self_destruct = true,
	rb655_turret_make_hostile = true,
	rb655_suitcharger_recharge = true,
	rb655_patrol_on = true,
	rb655_patrol_off = true,
	rb655_healthcharger_recharge = true,
	rb655_make_friendly = true,
	rb655_make_hostile = true,
	motioncontrol_ragdoll = true,
}
